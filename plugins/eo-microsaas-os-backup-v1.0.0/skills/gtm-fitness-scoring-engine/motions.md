# GTM Fitness Scoring Engine v3.0 — Motion Deep Intelligence

This file contains detailed intelligence for all 13 SMOrchestra GTM motions. Each motion includes: definition, real examples from the GTM Matrix, default scoring parameters, best fit conditions, win/fail conditions, MENA execution intelligence, and the 72-hour launch commitment.

Referenced from `SKILL.md` Section 6.
