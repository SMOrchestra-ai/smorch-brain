# GTM Fitness Scoring Engine v3.0 — Output Templates

This file contains the output file template and structure for the gtm-fitness.md assessment output.

Referenced from `SKILL.md` Section 9.
