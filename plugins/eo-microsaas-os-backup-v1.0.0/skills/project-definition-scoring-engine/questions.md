# EO Project Definition Scoring Engine — Questions Reference

All 21 questions across 6 sections (A-F). Each question includes: type, word limit, point value, question text, and student guidance.
...
**END OF questions.md — Project Definition Scoring Engine v1.0**
