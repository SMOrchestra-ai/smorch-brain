# Strategy Paths Reference -- Strategy Selector Engine

This file contains detailed strategy path descriptions, execution requirements, 90-day roadmaps, content-to-paid pipelines, 30-day validation experiments, and execution readiness question sets referenced by SKILL.md.

---

## FOUR STRATEGY PATHS -- DETAILED DESCRIPTIONS
...
## CONTENT-TO-PAID PIPELINE PER PATH
...
## FIRST EXPERIMENT DESIGN (BUILD-MEASURE-LEARN)
...
## EXECUTION READINESS QUESTIONS (SECTION D)

Path-specific question sets for Section D (20 points, 5 pts each question). System selects the appropriate set based on the founder's primary path choice from B5.
