...
### A2. Founder-Problem Fit (5 points)
...
### A3. Problem Validation Evidence (5 points)
...
### B4. Niche Validation Logic (5 points)
...
### B5. Niche Size Estimation (3 points)
...
## SECTION C RUBRICS: POSITIONING & DIFFERENTIATION (20 points)

### C1. Category Definition (5 points)
...
### C2. Competitive Alternatives (5 points)
...
**Context:** Alex Hormozi's Grand Slam Offer formula is: **(Dream Outcome x Perceived Likelihood) / (Time Delay x Effort & Sacrifice)**. This checkpoint surfaces during AI evaluation of Section C (C3 and C4 especially) to ensure positioning implies a compelling offer structure.
...
## SECTION D RUBRICS: PRODUCT VISION & SPEC (20 points)

### D1. Core Problem Statement (4 points)
...
### D4. Technical Approach (6 points)
...
## SECTION E RUBRICS: BRAND VOICE & FOUNDER STORY (10 points)

### E1. Attractive Character Type (3 points)
...
## SECTION F RUBRICS: MENA CONTEXT & LOCALIZATION (10 points)

### F1. Primary Geography (3 points)
...
### F3. Cultural Fit Assessment (4 points)
...
**END OF scoring-rubrics.md — Project Definition Scoring Engine v1.0**
