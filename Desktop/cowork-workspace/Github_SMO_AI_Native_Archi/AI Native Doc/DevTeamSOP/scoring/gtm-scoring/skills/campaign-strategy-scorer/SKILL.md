...
**Benchmark sources:** ColdIQ methodology, Instantly.ai 2026 Benchmark Report, GTM Strategist B2B State of GTM, Signal-to-Trust framework. Read `references/benchmarks-2026.md` for current numbers.
...
6. Assign verdict per `references/score-bands.md`
