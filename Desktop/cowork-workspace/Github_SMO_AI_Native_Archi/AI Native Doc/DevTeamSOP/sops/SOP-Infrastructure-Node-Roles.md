# SOP-6: Infrastructure Node Roles & Deployment
...
|----------|------------|---------|
| Claude Code | OAuth subscription (Max plan) | ✅ |
| OpenAI Codex | OAuth or paste-token | ✅ |
| Google Gemini | API key | ✅ (exception) |
| MiniMax | API key | ✅ (no OAuth available) |
