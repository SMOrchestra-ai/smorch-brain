# EO GTM Asset Factory - Asset Templates by GTM Motion

Reference file for all motion-specific asset templates (full and starter bundles).
...
## Marketplace/Platform (CONDITIONAL+)
