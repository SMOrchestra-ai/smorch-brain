# Asset Categories and Execution - eo-gtm-asset-factory

Complete breakdown of all asset types, generation specifications, and execution workflow.
...
## BRAND VOICE ENFORCEMENT BY ARCHETYPE

### The Closer (Results-First)

**Cold Email:**
- BAD: "I'd love to share how our platform can help your team."
- GOOD: "Your team lost 3 deals last month to slow follow-up. We fixed that for [similar company] in 48 hours."

**LinkedIn Post:**
- BAD: "Excited to announce our new feature!"
- GOOD: "Last week, a solo broker closed AED 180K because our auto-follow-up caught a lead he'd forgotten. Here's what happened:"

**WhatsApp:**
- BAD: "Hi! I wanted to introduce our solution."
- GOOD: "Saw your listing on Property Finder. Quick question: how many leads from that listing went cold last week?"

### The Builder (Show-Don't-Tell)

**Cold Email:**
- BAD: "We've built an amazing platform for brokers."
- GOOD: "Built a WhatsApp CRM that captures leads without the broker touching anything. 3-min demo: [link]"

**LinkedIn Post:**
- BAD: "We're passionate about solving real estate problems."
- GOOD: "Shipped lead auto-capture last week. Here's the 3-line code that made it work: [technical detail]. Result: 40% fewer lost leads."

**WhatsApp:**
- BAD: "Let me tell you about our product."
- GOOD: "Just shipped [feature]. Took 2 weeks. Here's a 30-sec screen recording: [link]"

### The Connector (Community-First)

**Cold Email:**
- BAD: "Our platform is trusted by many professionals."
- GOOD: "12 Dubai brokers are testing our WhatsApp CRM this month. They're sharing results in a private group. Want in?"

**LinkedIn Post:**
- BAD: "Building something great for the community!"
- GOOD: "Asked 20 brokers what they'd pay to never lose a WhatsApp lead again. Their answers surprised me. Thread:"

**WhatsApp:**
- BAD: "Hi, we have a great tool for you."
- GOOD: "[Name] from [mutual connection]'s network mentioned you. We're running a pilot with 5 brokers. Interested?"

---

## MENA AUTO-DETECTION LOGIC

### When to Apply MENA Adaptations

Check these fields from project-brain/ files:

1. **niche.md**: If "3-Level Niche" contains UAE, KSA, Saudi, Dubai, Riyadh, Egypt, Cairo, Gulf, GCC, MENA, Arab → MENA mode ON
2. **icp.md**: If "Primary Persona Location" contains any MENA country → MENA mode ON
3. **companyprofile.md**: If "Primary Geography" is MENA → MENA mode ON

If ANY of these trigger → apply ALL MENA adaptations below automatically. Do not ask.

### MENA Adaptations (Auto-Applied)
1. **WhatsApp sequences**: Generate Arabic variant (Gulf conversational, not MSA) alongside English
2. **Trust ordering**: Move social proof and credibility BEFORE the pitch in all sequences
3. **First touch**: Value-first, no ask. First message delivers insight or resource, not a meeting request
4. **Payment references**: Use AED/SAR amounts, not USD. Reference local payment methods (Tap, HyperPay, bank transfer)
5. **Timing**: Note Ramadan sensitivity in content calendar assets
6. **Relationship signals**: Add "mutual connection" and "community membership" as qualification criteria in ICP brief
7. **Email length**: Keep even shorter for MENA (max 100 words vs 150 for global)

---

## CONTENT DEPTH SPECIFICATIONS

### Per-Asset Word/Length Limits

| Asset Type | Max Words | Max Sections | Key Rule |
|-----------|-----------|-------------|----------|
| Cold email (single) | 100 | 3 paragraphs | One CTA. No greeting filler. |
| Cold email sequence (3-step) | 300 total | 3 emails | Each email shorter than previous |
| Cold email sequence (5-step) | 450 total | 5 emails | Email 5 is breakup (30 words max) |
| LinkedIn connection request | 50 | 1 paragraph | No pitch. Value or question only. |
| LinkedIn follow-up message | 80 | 2 paragraphs | Reference something specific about them |
| WhatsApp message | 40 | 2 sentences | Conversational. No formatting. |
| One-pager | 400 | 7 sections | Must fit on single page |
| YouTube script template | 800-1200 | Hook + 3-5 content blocks + CTA | Hook under 30 seconds |
| Lead magnet outline | 300 | Title + 5 sections + CTA | Not the content itself, just the structure |
| Blog template | 500-800 | H1 + 3-5 H2s + CTA | SEO structure with keyword placement |
| Landing page wireframe | 600 | 7-10 sections | Copy blocks, not code |
| Partner pitch | 400 | 5 sections | Mutual benefit > your benefit |
| Event brief | 500 | 8 sections | Logistics + content + follow-up |

### Depth by Tier

- **PRIMARY motion assets**: Full depth. Complete examples. A/B variants where specified.
- **SECONDARY motion assets**: 60% depth. One variant. No A/B testing.
- **CONDITIONAL motion assets**: Skeleton only. Headers + 1-sentence descriptions. Student fills in.

---

## PRIORITIZATION FOR 5+ PRIMARY MOTIONS

### Decision Logic

If student has more than 5 PRIMARY motions (score >= 8.0):

1. **Ask once**: "You have [N] PRIMARY motions. I'll produce all of them, but recommend starting deployment with your top 3. Want me to flag which 3 to deploy first?"
2. **If student says yes (or doesn't object)**: Rank PRIMARY motions by composite score. Top 3 get a "DEPLOY FIRST" tag in their README entry.
3. **If student says "do all"**: Produce all. No further questions.
4. **Never reduce scope without asking**. Always produce what the tier calls for.

### Production Order (when 5+ PRIMARY)

1. Core assets first (always)
2. Outbound Signal (if PRIMARY) - fastest to deploy
3. Dream 100 (if PRIMARY) - highest relationship ROI
4. Authority Education (if PRIMARY) - longest compound effect
5. Remaining PRIMARY motions in score order
6. All SECONDARY motions last

### Time Estimates

- Core assets: 5-10 minutes
- Each PRIMARY motion bundle: 8-15 minutes
- Each SECONDARY motion bundle: 3-5 minutes
- README generation: 2 minutes
- Total for 3 PRIMARY + 2 SECONDARY: ~40-60 minutes
- Total for 6 PRIMARY + 3 SECONDARY: ~90-120 minutes
