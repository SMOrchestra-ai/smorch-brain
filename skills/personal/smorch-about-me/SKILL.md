...
See `references/extraction-map.md` for the complete signal-to-file mapping tables (Founder, Employee, Generic). When parsing raw text in MODE A or MODE D, read that reference file to know which input signals map to which output file and section.
